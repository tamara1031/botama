...
type NotifyConfig struct {
	APIToken string
	APIAddr  string
	Channels map[string]string // keyed by level name, e.g. "info", "warning", "critical"
}
...
// loadNotifyChannels scans environment variables for NOTIFY_<LEVEL>_CHANNEL_ID
// entries and returns them as a map keyed by lowercase level name.
