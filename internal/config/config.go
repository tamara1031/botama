...
type NotifyConfig struct {
	APIToken string
	APIAddr  string
	// Channels maps lowercase level names (e.g. "info", "warning") to Discord channel IDs.
	// Populated dynamically from NOTIFY_<LEVEL>_CHANNEL_ID environment variables.
...
// loadNotifyChannels discovers notification channels from environment variables
// matching the pattern NOTIFY_<LEVEL>_CHANNEL_ID and maps them to lowercase level names.
