...
// loadNotifyChannels discovers channels from NOTIFY_<LEVEL>_CHANNEL_ID env vars.
// Any non-empty var matching the pattern is included, making new levels zero-config.
